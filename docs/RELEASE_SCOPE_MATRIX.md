...
2. Mobile runtime parity validation (Must — Build/launch PASS with latest release-like iOS evidence; acceptance/backend evidence BLOCKED pending end-to-end checklist and backend-traffic proof)
